...
Both of need to be compiled using
javac Server.java
javac Client.java
...
and cause the server and client to close

The log files are called server.log and client.log respectively

To run the bash script have two windows open again, one for the Server, one for the Client
bash server.sh
bash client.sh
